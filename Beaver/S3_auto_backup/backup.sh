...
OBJECTS_PATH=("/var/www/justalternate.fr/" "/var/lib/docker/volumes/owncloud_mysql/" "/var/lib/docker/volumes/owncloud_files/")
OBJECTS_NAME=("justalternate.fr.zip" "owncloud_mysql.zip" "owncloud_files.zip")
